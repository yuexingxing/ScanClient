...
public class ExampleInstrumentedTest {
    ...
    @Test
    public void xml2json_test001() throws Exception {
        try {
            // post 到 http://47.97.207.208/apiService/RFService.asmx 接口地址：
            /*
                注意：
...
<soap:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">
  <soap:Body>
    <HelloWorld xmlns="http://tempuri.org/">
      <tryConnectDb>1</tryConnectDb>
    </HelloWorld>
  </soap:Body>
</soap:Envelope>
             */
            // 服务器返回：返回xml数据格式 -- 原始内容如下：
...
"soap:Body":{"HelloWorldResponse":{"xmlns":"http:\/\/tempuri.org\/","HelloWorldResult":"Ok 2018-05-05 06:56:13"}},"xmlns:xsi":"http:\/\/www.w3.org\/2001\/XMLSchema-instance"}}
             */
        } catch (Exception e) {
            e.printStackTrace();
